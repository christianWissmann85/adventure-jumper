...
void main() {
  ...
  group('PHY-3.2.4: Player Responsiveness Validation', () {
    ...
    group('Input-to-Movement Latency Benchmarks', () {
      ...
      test('should maintain responsiveness during rapid input sequences', () async {
      ...
      test('should handle simultaneous inputs without latency increase', () async {
        ...
        verify(() => mockMovementCoordinator.handleMovementInput(any(), any(), any())).called(1);
    ...
    group('Jump Mechanics and Timing', () {
      test('should maintain variable jump height based on input duration', () async {
        ...
        for (final holdDuration in [50, 100, 200]) {
          ...
          when(() => mockPhysicsCoordinator.getVelocity(any()))
              .thenAnswer((_) async => Vector2(0, currentHeight > maxHeight ? 100 : -300));
      ...
      test('should maintain coyote time functionality', () async {
        ...
        await Future.delayed(Duration(milliseconds: (GameConfig.jumpCoyoteTime * 500).round()));
      ...
      test('should maintain jump buffer timing', () async {
        ...
        // Land shortly after
        await Future.delayed(Duration(milliseconds: (GameConfig.jumpBufferTime * 500).round()));
    ...
    group('Movement Quality Regression Tests', () {
      test('should not introduce input lag compared to baseline', () async {
        ...
        for (int i = 0; i < 100; i++) {
          ...
          // Simulate input through action name
        controller.handleInputAction('move_right', true);
          await Future.microtask(() => controller.update(0.001)); // Minimal frame time
